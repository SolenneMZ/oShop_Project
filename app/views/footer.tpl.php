            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p class="mb-3"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. At itaque
                            temporibus.</p>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-center text-md-left">
                        <p class="mb-md-0">© 2018 oShop. Tous droits réservés. <a href="<?php echo $router->generate('legal-notice'); ?>">Mentions légales</a>.</p>
                    </div>
                    <div class="col-md-6">
